...
At the heart of Dropsy, $DROPSY drives alignment and rewards the entire ecosystem, including:
...
This creates a **self-reinforcing loop** between distribution, participation, contribution, and long-term growth.

---

## 🔥 Key Concepts

### 1. Powering Protocol Features
...
- **Rewards** for active participants and NFT holders
- **Buybacks** funded by a portion of protocol revenue
- **Potential burns** to maintain scarcity and support floor price
- **Future governance** roles for community decision-making
...
Continue to **[Tokenomics →](#)** to explore supply, allocations, and staking mechanics.
